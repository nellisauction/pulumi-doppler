...
export class Environment extends pulumi.CustomResource {
     ...
     */
    declare public readonly personalConfigs: pulumi.Output<boolean | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: EnvironmentArgs | EnvironmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["personalConfigs"] = state?.personalConfigs;
            ...
            resourceInputs["personalConfigs"] = args?.personalConfigs;
...
export interface EnvironmentState {
     ...
     * Whether or not personal configs are enabled for the environment
     */
    personalConfigs?: pulumi.Input<boolean | undefined>;
    /**
     * The name of the Doppler project where the environment is located
     */
