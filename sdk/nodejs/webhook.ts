 ...
 *
 * const ci = new doppler.Webhook("ci", {
 *     project: testProj.name,
 *     url: "https://localhost/webhook",
 *     name: "My Webhook",
 *     secret: "my signing secret-2",
 *     enabled: true,
 *     enabledConfigs: [ciGithub.name],
 *     authentication: {
 *         type: "Bearer",
...
export class Webhook extends pulumi.CustomResource {
     ...
     */
    declare public readonly authentication: pulumi.Output<outputs.WebhookAuthentication | undefined>;
    /**
     ...
     */
    declare public readonly enabledConfigs: pulumi.Output<string[] | undefined>;
    /**
     * Name of the webhook
     */
    ...
    constructor(name: string, argsOrState?: WebhookArgs | WebhookState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["enabledConfigs"] = state?.enabledConfigs;
            ...
            resourceInputs["enabledConfigs"] = args?.enabledConfigs;
...
export interface WebhookState {
     ...
     * Authentication method used by the webhook
     */
    authentication?: pulumi.Input<inputs.WebhookAuthentication | undefined>;
    /**
     * Whether the webhook is enabled or disabled.  Default to true.
     */
     ...
     * Configs this webhook will trigger for
     */
    enabledConfigs?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * Name of the webhook
     */
